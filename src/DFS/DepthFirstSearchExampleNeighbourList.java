...
public class DepthFirstSearchExampleNeighbourList {
    ...
    public static void main(String arg[]) {
        ...
        dfsExample.searchByDepth(node40).stream().forEach((s) -> System.out.println(s.toString()));
